...
const Background = () => {
  ...
  if (bgPattern === 'white' || bgPattern === 'none') {
    return (
      <div className="fixed inset-0 pointer-events-none -z-50 bg-white dark:bg-stone-900 transition-colors duration-300" />
    );
  }
  ...
  if (bgPattern === 'grid') {
    ...
    return (
      <div className="fixed inset-0 pointer-events-none -z-50 bg-white dark:bg-stone-900 transition-colors duration-300">
        ...
        {/* The mask that fades the grid out at top/bottom */}
