...
const Home = () => {
  ...
  return (
    <div 
      className="min-h-screen bg-white dark:bg-stone-900 font-sans text-stone-900 dark:text-stone-100 selection:bg-[#FF4A1C]/20 relative transition-colors duration-200"
    ...
    >
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-stone-100 dark:bg-stone-800 border border-stone-300 dark:border-stone-700 text-sm font-medium text-stone-600 dark:text-stone-300 mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-7 duration-700 delay-300">
            <Link 
              to="/auth" 
              className="w-full sm:w-auto px-6 py-2.5 bg-white dark:bg-stone-800 text-stone-900 dark:text-white border border-stone-300 dark:border-stone-700 rounded-lg font-medium text-base hover:bg-stone-50 dark:hover:bg-stone-700 transition-all shadow-sm"
            >
              Start for free
            </Link>
            <Link 
              to="/classes" 
              className="w-full sm:w-auto px-6 py-2.5 bg-white dark:bg-stone-800 text-stone-900 dark:text-white border border-stone-300 dark:border-stone-700 rounded-lg font-medium text-base hover:bg-stone-50 dark:hover:bg-stone-700 hover:border-stone-400 dark:hover:border-stone-600 transition-all shadow-sm"
            >
              View Classes
            </Link>
          </div>
          ...
          <div className="mt-20 relative mx-auto max-w-5xl animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500">
            <div className="rounded-xl bg-stone-100 dark:bg-stone-800 p-2 ring-1 ring-inset ring-stone-900/10 dark:ring-white/10 lg:rounded-2xl lg:p-4 shadow-2xl shadow-stone-200 dark:shadow-stone-900/50">
              <div className="rounded-lg bg-white dark:bg-stone-900 overflow-hidden aspect-[16/9] border border-stone-200 dark:border-stone-700 relative group">
                {/* Abstract UI Representation */}
                <div className="absolute inset-0 bg-stone-50 dark:bg-stone-900 flex items-center justify-center">
                ...
                <div className="absolute top-10 left-10 w-64 p-4 bg-white dark:bg-stone-800 rounded-xl shadow-lg border border-stone-100 dark:border-stone-700 transform -rotate-2 hover:rotate-0 transition-transform duration-500">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-blue-600 dark:text-blue-400">
                      <Globe className="w-4 h-4" />
                    </div>
                    <div>
                      <div className="h-2 w-24 bg-stone-200 dark:bg-stone-600 rounded mb-1"></div>
                      <div className="h-1.5 w-16 bg-stone-100 dark:bg-stone-700 rounded"></div>
                    </div>
                  </div>
                  <div className="h-2 w-full bg-stone-100 dark:bg-stone-700 rounded mb-2"></div>
                  <div className="h-2 w-2/3 bg-stone-100 dark:bg-stone-700 rounded"></div>
                </div>

                <div className="absolute bottom-10 right-10 w-64 p-4 bg-white dark:bg-stone-800 rounded-xl shadow-lg border border-stone-100 dark:border-stone-700 transform rotate-3 hover:rotate-0 transition-transform duration-500">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="w-8 h-8 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center text-green-600 dark:text-green-400">
                      <Check className="w-4 h-4" />
                    </div>
                    <div>
                      <div className="h-2 w-20 bg-stone-200 dark:bg-stone-600 rounded mb-1"></div>
                      <div className="h-1.5 w-12 bg-stone-100 dark:bg-stone-700 rounded"></div>
                    </div>
                  </div>
                  <div className="flex gap-2">
                    <div className="h-8 flex-1 bg-stone-50 dark:bg-stone-700 rounded border border-stone-100 dark:border-stone-600"></div>
                    <div className="h-8 flex-1 bg-black dark:bg-stone-950 rounded"></div>
                  </div>
                </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="p-8 rounded-3xl bg-stone-50 dark:bg-stone-800/50 border border-stone-300 dark:border-stone-700 hover:border-stone-400 dark:hover:border-stone-600 transition-colors group">
              <div className="w-12 h-12 bg-white dark:bg-stone-700 rounded-2xl border border-stone-300 dark:border-stone-600 flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 transition-transform">
      ...
      <section className="py-24 border-t border-stone-300 dark:border-stone-800">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
             <Link 
              to="/auth" 
              className="px-6 py-2.5 bg-white dark:bg-stone-800 text-stone-900 dark:text-white border border-stone-300 dark:border-stone-700 rounded-lg font-medium hover:bg-stone-50 dark:hover:bg-stone-700 transition-all shadow-sm"
            >
