...
const Create = () => {
  ...
  return (
    <div 
      className="min-h-screen bg-white dark:bg-stone-900 pt-24 pb-12 px-4 sm:px-6 relative transition-colors duration-200"
    ...
    >
      ...
      <div className="max-w-3xl mx-auto relative z-10">
          ...
          <div className="text-center mb-10 pt-20">
            <div className="mb-8">
              <h1 className="inline-block text-6xl text-stone-900 dark:text-white tracking-tight bg-white/90 dark:bg-stone-800/90 backdrop-blur-sm px-8 py-62 rounded-3xl ">
                What are we learning today?
              </h1>
            </div>
            <div className="mb-10">
              <p className="inline-block text-stone-500 dark:text-stone-400 text-lg bg-white/90 dark:bg-stone-800/90 backdrop-blur-sm px-8 py-4 rounded-2xl max-w-2xl mx-auto leading-relaxed">
        ...
        {/* Main Input Card */}
        <div 
          className="rounded-2xl shadow-xl border border-stone-300 dark:border-stone-700 overflow-hidden bg-white dark:bg-stone-800 transition-colors duration-200"
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="flex gap-4 h-[180px]">
                  ...
                  {!formData.fileUpload ? (
                    <div
                      ...
                      className={`h-full border border-dashed rounded-lg p-4 flex flex-col items-center justify-center text-center cursor-pointer transition-all ${
                        isDragging 
                          ? 'border-stone-500 bg-stone-50 dark:bg-stone-700' 
                          : 'border-stone-300 dark:border-stone-600 hover:border-stone-400 dark:hover:border-stone-500 hover:bg-stone-50 dark:hover:bg-stone-700'
                      }`}
                    >
                      <input
                        ref={fileInputRef}
                      ...
                      />
                      <div className="p-2 bg-stone-100 dark:bg-stone-700 rounded-lg text-stone-500 dark:text-stone-400 mb-2">
                         <Paperclip className="w-5 h-5" />
                      </div>
                      <p className="text-sm font-medium text-stone-900 dark:text-white">Upload file</p>
                      
                    </div>
                  ) : (
                    <div className="h-full border border-stone-300 dark:border-stone-600 rounded-lg p-4 bg-stone-50 dark:bg-stone-700/50 flex flex-col items-center justify-center text-center relative group">
                      <div className="p-2 bg-white dark:bg-stone-800 border border-stone-300 dark:border-stone-600 rounded-lg text-[#FF4A1C] mb-2 shadow-sm">
                         <FileText className="w-5 h-5" />
                      </div>
                      <p className="text-sm font-medium text-stone-900 dark:text-white line-clamp-2 px-2 break-all">
                      ...
                      <button
                        ...
                        className="absolute top-2 right-2 p-1.5 bg-white dark:bg-stone-800 border border-stone-300 dark:border-stone-600 rounded-md text-stone-500 dark:text-stone-400 hover:text-red-600 dark:hover:text-red-400 hover:border-red-300 dark:hover:border-red-500 transition-colors opacity-0 group-hover:opacity-100"
                      >
              ...
              <div className={mode === 'classwork' ? 'flex-1' : 'w-full'}>
                 <textarea
                  ...
                  className="w-full h-full p-3 bg-white dark:bg-stone-900 border border-stone-300 dark:border-stone-600 rounded-lg text-sm text-stone-900 dark:text-white placeholder:text-stone-400 dark:placeholder:text-stone-500 resize-none focus:outline-none focus:border-stone-500 focus:ring-0 leading-relaxed transition-all"
                />
              </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-stone-300 dark:border-stone-700">
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-medium transition-all border ${
                    mode === 'classwork' 
                      ? 'bg-stone-100 dark:bg-stone-700 text-stone-900 dark:text-white border-stone-300 dark:border-stone-600' 
                      : 'text-stone-500 dark:text-stone-400 border-transparent hover:bg-stone-50 dark:hover:bg-stone-700 hover:text-stone-900 dark:hover:text-white'
                  }`}
                >
              ...
              <button
                ...
                disabled={loading}
                className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-stone-700 text-stone-900 dark:text-white border border-stone-300 dark:border-stone-600 rounded-lg font-medium text-sm hover:bg-stone-50 dark:hover:bg-stone-600 transition-all disabled:opacity-50 shadow-sm"
              >
                {loading ? (
                  <>
        ...
        {mode === 'classwork' && (formData.fileUpload || formData.textInput.trim().length > 0 || selectedClassId || isCreatingClass) && (
          <div className="mt-6 flex gap-6 items-start">
            <div className="rounded-2xl shadow-xl border border-stone-300 dark:border-stone-700 overflow-hidden bg-white dark:bg-stone-800 max-w-[300px] w-full animate-in fade-in slide-in-from-top-4 duration-500">
              <div className="p-5">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    >
                      <div className={`
                        ...
                        ${selectedClassId === cls.id 
                          ...
                          : 'border-stone-300 dark:border-stone-600 bg-white dark:bg-stone-700 group-hover:border-stone-400 dark:group-hover:border-stone-500'
                        }
                      `}>
                         {/* No inner dot needed if we fill the background */}
                      </div>
                      <span className={`text-sm transition-colors truncate ${
                        selectedClassId === cls.id ? 'text-stone-900 dark:text-white font-medium' : 'text-stone-600 dark:text-stone-400 group-hover:text-stone-900 dark:group-hover:text-white'
                      }`}>
                        {cls.name}
                      </span>
                    </button>
                  ...
                  {isCreatingClass ? (
                    <div ref={wrapperRef} className="flex items-center gap-3 pl-[0px] w-full animate-in fade-in slide-in-from-left-2">
                      <div className="w-3 h-3 rounded-full border border-stone-300 dark:border-stone-600 flex-shrink-0 bg-white dark:bg-stone-700" />
                      <div className="flex-1 flex items-center gap-2">
                        <input
                          ...
                          autoFocus
                          className="bg-white dark:bg-stone-900 border-stone-300 dark:border-stone-600 focus:border-[#FF4A1C] focus:ring-0 text-sm text-stone-900 dark:text-white placeholder:text-stone-600 dark:placeholder:text-stone-500 placeholder:font-normal w-full px-0 py-1 outline-none transition-all"
                          onKeyDown={(e) => {
                    ...
                    >
                      <div className="w-3 h-3 rounded-full border border-stone-200 dark:border-stone-600 flex items-center justify-center transition-all flex-shrink-0 bg-white dark:bg-stone-700 group-hover:border-[#FF4A1C]/50">
                      </div>
            ...
            {(selectedClassId || isCreatingClass) && (
              <div className="rounded-2xl shadow-xl border border-stone-300 dark:border-stone-700 overflow-hidden bg-white dark:bg-stone-800 flex-1 animate-in fade-in slide-in-from-left-4 duration-500">
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-3 pl-[0px] w-full">
                    ...
                    <input
                      ...
                      className=" pl-4 bg-white dark:bg-stone-900 border-stone-300 dark:border-stone-600 focus:border-[#FF4A1C] focus:ring-0 text-sm text-stone-900 dark:text-white placeholder:text-stone-600 dark:placeholder:text-stone-500 placeholder:font-normal w-full px-0 py-1 outline-none transition-all"
                    />
                  </div>
                </div>
              </div>
